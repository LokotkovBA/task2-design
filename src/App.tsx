        ...
        <>
            ...
            <main className="content">
                <section className="content__main">
                    <h1 className="main__heading">
                        ...
                        <b className="bold-gradient">с WELBEX</b>
                    </h1>
                    <p className="main__p">
                ...
                <section className="content__side">
                    ...
                    <ul className="list side__list">
                        <li className="item item--mobile-line">
                            <h3 className="item__heading">ВИДЖЕТЫ</h3>
                            <p className="mobile-hide">30 готовых решений</p>
                        </li>
                        <li className="item item--mobile-line">
                        ...
                        <li className="item item--mobile-line">
                            ...
                            <p className="mobile-hide">использования CRM</p>
                        </li>
                    </ul>
            ...
            <footer className="footer">
                ...
                <section className="footer__contacts">
                    ...
                    <p>Москва, Путевой проезд 3с1, к 901</p>
                </section>
            </footer>
            <div className="trademark">
                <p>©WELBEX 2022. Все права защищены.</p>
                <a className="trademark__a">Политика конфиденциальности</a>
            </div>
