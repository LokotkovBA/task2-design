        ...
        <>
            <header className="header">
                <div className="header__main-logo">
                    <MainLogo />
                    <p className="main-logo__p p">
                        крупный интегратор CRM в России и ещё 8 странах
                    </p>
                </div>
                <nav>
                    <menu className="list header__list">
                        <li>Услуги</li>
                        <li>Виджеты</li>
                        <li>Интеграции</li>
                        <li>Кейсы</li>
                        <li className="mobile-hide">Сертификаты</li>
                    </menu>
                </nav>
                <p className="header__phone mobile-hide">+7 555 555-55-55</p>
                <div className="header__logos mobile-hide">
                    <TelegramLogo />
                    <ViberLogo />
                    <WhatsAppLogo />
                </div>
            ...
            <main className="content">
                <section className="content__main">
                    <h1 className="main__heading">
                        ...
                        <b className="bold bold-gradient">с WELBEX</b>
                    </h1>
                    <p className="main__p p">
                ...
                <section className="content__side">
                    <h2 className="side__heading">
                        Вместе с{" "}
                        <b className="bold-gradient2 mobile-tolower">
                            БЕСПЛАТНОЙ
                        </b>{" "}
                        <b className="bold-gradient mobile-tolower">
                            КОНСУЛЬТАЦИЕЙ
                        </b>{" "}
                        мы дарим:
                    </h2>
                    <ul className="list side__list">
                        <li className="mobile-hide item">
                            <h3 className="item__heading">ВИДЖЕТЫ</h3>
                            <p className="p">30 готовых решений</p>
                        </li>
                        <li className="item item--mobile-line item--dashboard">
                            <h3 className="item__heading">DASHBOARD</h3>
                            <p className="p mobile-hide">
                                с показателями вашего бизнеса
                            </p>
                        </li>
                        <li className="item item--mobile-line item--skype">
                            <h3 className="item__heading">SKYPE АУДИТ</h3>
                            <p className="p mobile-hide">
                                отдела продаж и CRM системы
                            </p>
                        </li>
                        <li className="desktop-hide item item--mobile-line">
                            <h3 className="item__heading">30 ВИДЖЕТОВ</h3>
                        </li>
                        <li className="mobile-hide item">
                            <h3 className="item__heading">35 ДНЕЙ</h3>
                            <p className="p mobile-hide">использования CRM</p>
                        </li>
                        <li className="desktop-hide item item--mobile-line">
                            <h3 className="item__heading">МЕСЯЦ AMOCRM</h3>
                        </li>
                    </ul>
                    <button className="side__button mobile-hide">
                        Получить консультацию
                    </button>
                </section>
                <div className="purple-blob" />
                <div className="red-blob" />
                <div className="big-red-ball" />
            ...
            <footer>
                <section className="footer">
                    <section className="footer__about">
                        ...
                        <menu className="list about__list">
                            <li>Партнёрская программа</li>
                            <li>Вакансии</li>
                        </menu>
                    </section>
                    <section>
                        <h3 className="heading">МЕНЮ</h3>
                        <menu className="list footer__list">
                            <li className="footer__item">Расчёт стоимости</li>
                            <li className="desktop-hide">
                                Благодарность клиентов
                            </li>
                            <li className="footer__item">Услуги</li>
                            <li className="footer__item">Кейсы</li>
                            <li className="footer__item mobile-hide">
                                Благодарственные письма
                            </li>
                            <li className="footer__item">Виджеты</li>
                            <li className="footer__item">Сертификаты</li>
                            <li className="footer__item">Интеграция</li>
                            <li className="footer__item">Блог на Youtube</li>
                            <li className="footer__item">Наши клиенты</li>
                            <li className="footer__item">Вопрос / Ответ</li>
                        </menu>
                    </section>
                    <section className="footer__contacts">
                        <h3 className="heading contacts__heading">КОНТАКТЫ</h3>
                ...
                <div className="trademark">
                    <p className="p">©WELBEX 2022. Все права защищены.</p>
                    <a className="p trademark__a">
